...
export const PlaybackOptions = ({ player }: PlaybackOptionsProps) => {
    ...
    useEffect(() => {
        player.getVolume().then((volume) => {
            setProgressBarWidth(volume * 100 + "%");
            setVolume(volume);
    ...
    return (
        <div className={css.container}>
            <div onClick={handleClickPlayQueue}>
                ...
                {showDevices && devices && (
                    <DeviceOption
                        ...
                        availableDevices={devices.devices.filter(
                            (device) => !device.is_active,
                        )}
                    />
                )}
            ...
            <div
                ...
                onMouseEnter={() =>
                    handleMouseOver("Enter", "volumeProgressBar")
                }
                onMouseLeave={() => {
                    setIsDragging(false);
                    handleMouseOver("Leave", "volumeProgressBar");
                }}
