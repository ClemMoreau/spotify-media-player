...
const DeviceOption = ({currentDevice, availableDevices}: DeviceOptionProps) => {
            ...
            <div className={css.absoluteContainer}>
                <div className={css.deviceContainer}>
                    ...
                    <div className={css.deviceInfo}>
                        ...
                        <div className={css.currentDevice}>{currentDevice.name}</div>
                    </div>
                </div>
                <div className={css.select}>
                    Sélectionnez au autre appareil
                </div>
                {availableDevices.map(device => {
                    return(
                    <div className={css.deviceContainer} onClick={() => handleDeviceChange(device)}>
                        <div className={css.deviceIcon}>
